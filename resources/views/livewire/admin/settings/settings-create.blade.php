<div>
    <x-modal.card title="Edit User" blur wire:model.defer="showCreateModel">
...
{{--                                x-on:livewire-upload-finish="isUploading = false"--}}
                            ...
                            <label for="dropzone-file"
                                ...
                                <input id="dropzone-file" wire:model="value" type="file" accept="application/msword, application/pdf"
                                       class="hidden"/>
                            </label>
...
{{--                                x-on:livewire-upload-progress="progress = $event.detail.progress"--}}
{{--                        >--}}
{{--                            <input type="file" wire:model="value" accept="application/msword, application/pdf">--}}
{{--                            @if(!empty($value))--}}
{{--                                <x-button.circle--}}
{{--                                        x-on:click="@this.removeUpload('value', '{{ $value->getFilename() }}')"--}}
{{--                                        primary icon="x"/>--}}
            ...
            <x-slot name="footer">
                <div class="flex justify-between gap-x-4">
                    ...
                    <div class="flex gap-x-4">
                        ...
                        <x-button primary label="Save" type="submit" wire:click="create" wire:loading.attr="disabled"/>
                    </div>
                </div>
            </x-slot>
        </form>
