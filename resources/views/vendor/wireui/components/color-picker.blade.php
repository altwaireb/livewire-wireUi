<div x-data="wireui_color_picker({
    ...
    <x-dynamic-component
        ...
        x-bind:class="{ 'ltr:pl-8 rtl:pr-8': selected.value }"
        ...
        <x-slot name="append">
            <div class="absolute inset-y-0 ltr:right-0 rtl:left-0 flex items-center p-0.5">
                <x-dynamic-component
                    :component="WireUi::component('button')"
                    class="h-full ltr:rounded-r-md rtl:rounded-l-md"
                    primary
                    flat
                    squared
                    x-on:click="toggle"
